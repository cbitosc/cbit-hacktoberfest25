        ...
        try {
          ...
          querySnapshot.forEach((doc) => {
            ...
            if (regData.teamSize < 3 && regData.techStack) {
              ...
              } else if (typeof regData.techStack === 'string' && regData.techStack) {
                try {
          ...
          // console.log("Fetched complete team members from registrations:", allMembers);
        } catch (error) {
          console.error("Error fetching team members from registrations:", error);
        } finally {
        ...
        >
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="p-4 sm:p-6 rounded-xl bg-gradient-to-r from-[#25D366]/20 to-[#25D366]/10 border border-[#25D366]/40 backdrop-blur-sm">
              ...
              <p
                ...
                style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif" }}
              >
                ALL team members must join our WhatsApp group for important updates, announcements, and team coordination.
              </p>
              <div className="flex flex-col gap-3 justify-center">
                <button
            ...
            {(teamMembers.length > 0 || loadingTeamDetails) && (
              <div className="mt-8 space-y-4">
                ...
                {loadingTeamDetails ? (
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <span
                              className={`text-xs sm:text-sm font-medium capitalize ${
                                member.role === 'leader' ? 'text-[#8A86FF]' : 'text-[#C2C2FF]'
                              }`}
                              style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif" }}
                            >
                        ...
                        <div className="space-y-3 text-sm">
                          ...
                          <div className="flex items-start space-x-2">
                            <div className="flex items-center space-x-2 flex-shrink-0">
                              ...
                              <span className="text-[#C2C2FF] font-medium">Email:</span>
                            </div>
                            <span className="text-[#D0CCE3] break-words min-w-0">{member.email}</span>
                          </div>
                          ...
                          {member.phoneNumber && (
                            <div className="flex items-start space-x-2">
                              <div className="flex items-center space-x-2 flex-shrink-0">
                                ...
                                <span className="text-[#C2C2FF] font-medium">Phone:</span>
                              </div>
                              <span className="text-[#D0CCE3] break-words min-w-0">{member.phoneNumber}</span>
                            </div>
                          )}

                          {/* Academic Info - Grouped together */}
                          {(member.college || member.branch || member.degree || member.yearOfStudy || member.rollNumber) && (
                            <div className="mt-4 pt-3 border-t border-[#5E577C]/30">
                              <h5 className="text-[#C2C2FF] font-medium mb-2 text-xs uppercase tracking-wide">Academic Details</h5>
                              <div className="space-y-2">
                                {member.college && (
                                  <div className="flex items-start space-x-2">
                                    <div className="flex items-center space-x-2 flex-shrink-0">
                                      <School className="w-4 h-4 text-[#C2C2FF]" />
                                      <span className="text-[#C2C2FF] font-medium">College:</span>
                                    </div>
                                    <span className="text-[#D0CCE3] break-words min-w-0">{member.college}</span>
                                  </div>
                                )}
                                ...
                                {member.branch && (
                                  <div className="flex items-start space-x-2">
                                    <div className="flex items-center space-x-2 flex-shrink-0">
                                      ...
                                      <span className="text-[#C2C2FF] font-medium">Branch:</span>
                                    </div>
                                    <span className="text-[#D0CCE3] break-words min-w-0">{member.branch}</span>
                                  </div>
                                )}
                                ...
                                {member.degree && (
                                  <div className="flex items-start space-x-2">
                                    <div className="flex items-center space-x-2 flex-shrink-0">
                                      ...
                                      <span className="text-[#C2C2FF] font-medium">Degree:</span>
                                    </div>
                                    <span className="text-[#D0CCE3] break-words min-w-0">{member.degree}</span>
                                  </div>
                                )}
                                  ...
                                  {member.yearOfStudy && (
                                    <div className="flex items-start space-x-2">
                                      <div className="flex items-center space-x-2 flex-shrink-0">
                                        ...
                                        <span className="text-[#C2C2FF] font-medium">Year:</span>
                                      </div>
                                      <span className="text-[#D0CCE3] break-words min-w-0">{member.yearOfStudy}</span>
                                    </div>
                                  )}
                                  ...
                                  {member.rollNumber && (
                                    <div className="flex items-start space-x-2">
                                      <div className="flex items-center space-x-2 flex-shrink-0">
                                        ...
                                        <span className="text-[#C2C2FF] font-medium">Roll No:</span>
                                      </div>
                                      <span className="text-[#D0CCE3] break-words min-w-0">{member.rollNumber}</span>
                                    </div>
                                  )}
                                </div>
                              </div>
                  ...
                  <div className="text-center py-4">
                    <p className="text-[#C2C2FF]">No detailed team information available.</p>
                  </div>
                )}
                
                {/* Tech Stack Display - Only for small teams */}
                {techStack && Array.isArray(techStack) && techStack.length > 0 && teamSize < 3 && (
                  <div className="mt-6">
                    <h4
                ...
                <div className="flex justify-center mt-6">
                  <button
                    onClick={() => navigate('/edit-team-details', {
                      state: {
                        registration: {
                          ...registrationData,
                          leaderEmail: registrationData.leaderEmail || registrationData.leader?.email
                        }
                      }
                    })}
            ...
            {/* Special Message for Small Teams */}
            {teamSize < 3 && (
              <div
            ...
            {existingRegistration && (
              ...
              >
                ...
                <p
                  ...
                  style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif" }}
                >
                  You have already completed your registration for CBIT Hacktoberfest
                  2025. If you need to make any changes to your registration,
          ...
          <div className="p-4 rounded-lg bg-[#403F7D]/20 border border-[#5E577C]/50 mb-8">
            ...
            <p
              ...
              style={{ fontFamily: "'Atkinson Hyperlegible', sans-serif" }}
            >
              Contact the organizers for any questions or
              assistance
            </p>
          </div>
